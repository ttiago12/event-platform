          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-4 mt-6">
              <img
                ...
                src="https://github.com/ttiago12.png"
                alt= "" 
               />
              <div className="leading-relaxed">
                <strong className="font-bold text-2xl block">Tiago Francisco</strong>
                <span className="text--grat-200 text-sm block">CTO at LoremIpsom</span>
              </div>
            </div>
